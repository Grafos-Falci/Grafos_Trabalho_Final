...
//        Graph.createStringDotToPng(grafo.imprimeArvore(), "newtree");
            ...
            GrafoOrientado grafoOrienta = new GrafoOrientado();
            grafoOrienta = grafo;

            grafoOrienta.malgrange();
            Graph.createStringDotToPng(grafoOrienta.dotOrientado(), "malgrangeorienta");
            Graph.createStringDotToPng(grafo.dotOrientado(), "noraml");
